...
description: Tìm kiếm thiết kế database hoặc đặc tả bảng dữ liệu theo ngữ nghĩa gần đúng nhất qua mcp tool.
---
...
## Triggers
- Kích hoạt khi viết hoặc sửa đổi DB Specs của Story cần đối chiếu cấu trúc database cũ.
...
|----------------|-------------|------------|
| Không tìm thấy kết quả | Không có bảng nào khớp ngữ nghĩa | Báo cáo User, quét mã nguồn local để lấy cấu trúc thực tế và tiếp tục. |
