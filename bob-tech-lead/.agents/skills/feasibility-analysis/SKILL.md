...
|-----|--------------|-------|
| feasibilityReport | File | Đẩy trực tiếp đặc tả `feasibility_check.md` lên hệ thống qua tool `upload_story_doc`. |
...
5. **Đẩy lên hệ thống:** Gọi mcp tool `upload_story_doc` để lưu trữ báo cáo khả thi trực tiếp trên Story.
