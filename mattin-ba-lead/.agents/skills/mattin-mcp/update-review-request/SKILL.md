...
## Description
Kỹ năng giúp Mattin đẩy kết quả thẩm định cuối cùng lên hệ thống lưu trữ tập trung của dự án thông qua `mattin-mcp`, ghi nhận trạng thái duyệt (APPROVED/REJECTED) và đính kèm biên bản báo cáo lỗi chi tiết.
...
2. **Gọi tool hệ thống:**
   - Gọi tool `update_review_request` từ `mattin-mcp` truyền vào 3 tham số trên.
3. **Báo cáo kết quả:**
