# HƯỚNG DẪN VIẾT TÀI LIỆU 01-overview.md (PROJECT CHARTER)

Tài liệu `01-overview.md` đóng vai trò là "Bản tuyên ngôn dự án" (Project Charter). Mục đích của file này là để bất kỳ ai (Dev, QA, BA, Khách hàng hoặc thành viên mới) chỉ cần đọc trong 5 phút là hiểu được **"Dự án này sinh ra để làm gì, giải quyết nỗi đau nào, và hình hài tổng quan của nó ra sao?"**.
